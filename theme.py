...
def wa():
    os.system('xdg-open http://wa.me/6282125068665?text=Assalamualaikum')
...
def lodhirt():
    lodhirt = [
     'kanchil ID', '      ', 'kanchil ID', '      ', 'kanchil ID', '      ', 'kanchil ID', '      ', 'kanchil ID', '      ', 'kanchil ID', '      ', 'kanchil ID', '      ', 'kanchil ID', '      ', 'kanchil ID', '      ', 'kanchil ID', 'kanchil ID', '      ', 'kanchil ID', '      ', 'kanchil ID', '      ', 'kanchil ID', '      ', 'kanchil ID', '      ', 'kanchil ID', '      ', 'kanchil ID', '      ', 'kanchil ID', '      ', 'kanchil ID', '      ', 'kanchil ID\n']
    for o in lodhirt:
